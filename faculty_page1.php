...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <li><a href="#">Username: <?php echo $_SESSION['faculty_username'];  ?></a></li>
      
    </ul>
    <ul class="nav navbar-nav navbar-right">
        <li><a href="faculty_page.php">Add Student</a></li>
...
<div id="section1">
    <ul class="nav nav-tabs" style="padding-left: 40%;">
        <li><a href="faculty_page.php#GAttendance">Give Attendance</a></li>
    ...
    <div class="search-stud-details" style="margin-left:30px;width: 250px;">
        ...
        <span style="font-family: bolder;font-size: 25px;">Enter Registration No: </span><br>
